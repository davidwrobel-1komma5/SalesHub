...
const navigation = [
  ...
  { id: 'pitch', href: 'heizungsförderung.html', label: 'Wissen & Argumentation', icon: icons.pitch },
  { id: 'calculator', href: 'heizungsförderrechner.html', label: 'Förderrechner', icon: icons.calculator },
