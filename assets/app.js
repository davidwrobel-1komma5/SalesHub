  ...
  document.body.insertAdjacentHTML('afterbegin', `
    ...
    <div class="app-shell">
      ...
      <aside class="sidebar" id="main-navigation" aria-label="Hauptnavigation" data-open="false">
        <a class="brand-lockup" href="index.html" aria-label="SalesHub Startseite"><span class="brand-name">1KOMMA5°</span><span class="brand-compact" aria-hidden="true">1K5°</span><span class="brand-product">SalesHub</span></a>
